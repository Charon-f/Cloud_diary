...
<div class="container">
    ...
    <%--个人中心--%>
    <%--<jsp:include page="note/info.jsp"></jsp:include>--%>
    <%--类别管理--%>
    <%--<jsp:include page="note/lint.jsp"></jsp:include>--%>
    <%--通过后台设置动态显示的页面，通过包含加载进来--%>
    <%--进行判断
    如果获取到后台传递的值，则显示相对应的内容，如果没有，则显示默认值--%>

    <c:if test="%${empty changPage}">
        <jsp:include page="note/list.jsp"></jsp:include>
    </c:if>
    <c:if test="${! empty changPage}">
        <jsp:include page="${changPage}"></jsp:include>
    </c:if>
